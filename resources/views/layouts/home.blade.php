                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('admin.business') }}"
                               class="{{ request()->routeIs('admin.business*') && !request()->routeIs('admin.business-users*') ? 'active' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.business-users') }}"
                               class="{{ request()->routeIs('admin.business-users*') ? 'active' : '' }}">
                                <span class="menu-side">
                        ...
                        @auth
                            @if(Auth::user()->hasRole('super_admin'))
                                <li>
                                    ...
                                    class="{{ request()->routeIs('admin.admin-user*') ? 'active' : '' }}">
                                        <span class="menu-side">
