                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <select class="form-control select2" name="role" id="role">
                                        ...
                                        @if(auth()->user()->hasPermissionTo('Create_Manager'))
                                            <option value="manager">Manager</option>
                                        @endif

                                        @if(auth()->user()->hasPermissionTo('Create_Reception'))
                                            <option value="reception">Reception</option>
                                        @endif

                                        @if(auth()->user()->hasPermissionTo('Create_Technician'))
                                    ...
                                    <small class="text-danger font-weight-bold err_role"></small>
                                </div>
                            </div>
