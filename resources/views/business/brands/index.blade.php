...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;">Manage Brands </a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                {{-- @if (Auth::user()->hasPermissionTo('Create_User')) --}}
                                    <a href="{{ route('business.brands.create.form') }}" class="btn btn-primary ms-2">
                                        +&nbsp;New Brand
                                    </a>
                                {{-- @endif --}}
                            </div>
