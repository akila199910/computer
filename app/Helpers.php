...
if (!function_exists('action_btns_2')) {
    function action_btns_2($action, $user, $permission, $edit_url, $route_id,  $view_url,$download_url)
    {
        if ($edit_url != '' && $user->hasPermissionTo('Update_' . $permission)) {
            $action .= '<a class="dropdown-item" title="Edit" href="' . $edit_url . '"><i class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>';
        }
        ...
        if ($user->hasPermissionTo('Read_' . $permission) && $download_url != '') {
            $action .= '<a class="dropdown-item" title="Download" href="' . $download_url . '">
